...
class Cell:
    ...
    def draw(self, x1, y1, x2, y2 ):
        ...
        self._x2 = x2
        self._y2 = y2
        top_left = Point(min(self._x1, self._x2), max(self._y1, self._y2))
        top_right = Point(max(self._x1, self._x2), max(self._y1, self._y2))
        bottom_left = Point(min(self._x1, self._x2), min(self._y1, self._y2))
        bottom_right = Point(max(self._x1, self._x2), min(self._y1, self._y2))
